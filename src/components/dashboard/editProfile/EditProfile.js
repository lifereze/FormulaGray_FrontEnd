    ...
    <>
      <div className=" grid grid-cols-12">
        ...
        <div className="md:col-span-10 col-span-12 h-screen overflow-y-scroll w-full overflow-x-hidden">
          <Banner />
          <div className=" grid grid-cols-12  mx-6 h-full">
            <div className=" col-span-3  border-r-2 pt-5 bg-gray-100 rounded-xl">
              <div className=" flex items-center justify-evenly px-4  cursor-pointer ">
                <div className="">
            ...
            <div className=" col-span-9 px-5 pt-2">
                ...
                <div className="sm:col-span-6">
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      placeholder="1254 Haysuite Lane"
                      className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    />
                    {/* {phoneError && (
                      <div className=" text-red-500 text-sm">{phoneError}</div>
