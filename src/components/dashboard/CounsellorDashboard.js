...
import {
  ...
  counsellorGetAllRecruitmentPartners,
...
export const CounsellorDashboard = () => {
  ...
  const [recruitmentPartners, setRecruitmentPartners] = useState(0);
  ...
  useEffect(() => {
    const getStudents = async () => {
      ...
      setRecruitmentPartners(res?.data?.assignedRecruitmentPartners?.length);
    };
    if (!students) {
      getStudents();
    }
                  ...
                  <div className="md:px-10 px-4   pb-10 ">
                    <div className="grid    grid-cols-12 gap-x-4 gap-y-2 ">
                      <div className=" md:col-span-3 col-span-6">
                        <Link to="/counsellorApplications">
                          <Info
                            icon={
                      ...
                      <div className=" md:col-span-3 col-span-6">
                        <Link to="/counsellorApplications/accepted">
                          <Info
                            icon={
                      ...
                      <div className=" md:col-span-3 col-span-6">
                        <Link to="/counsellorApplications/rejected">
                          <Info
                            icon={
                      ...
                      <div className=" md:col-span-3 col-span-6">
                        <Link to="/counsellorPartners">
                          <Info
                            icon={
                              <MdCastForEducation className=" text-4xl text-white" />
                            }
                            number={
                              recruitmentPartners ? recruitmentPartners : 0
                            }
