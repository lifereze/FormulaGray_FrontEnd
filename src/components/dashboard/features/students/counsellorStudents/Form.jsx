...
import { useCounsellorAddStudentMutation } from './counsellorStudentsApiSlice';
export const Form = (props) => {
    const [counsellorAddStudent, { isLoading, error }] = useCounsellorAddStudentMutation();
...
const [otherFilesUrls,setOtherFilesUrls] = useState([]);
  ...
  const onSubmitHandler= async ()=>{
    if(user?.approvalStatus!=='pending'){
      ...
      const res= await counsellorAddStudent({
        firstName,
        lastName,
