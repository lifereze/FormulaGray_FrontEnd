...
export const Hero = () => {
  return (
    <main className={`lg:relative bg-[${colors.primary}]`}>
        ...
        <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
          ...
          <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
              <a
                href="#"
                className={`flex w-full items-center justify-center rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-[${colors.primary}] hover:bg-gray-250 md:py-4 md:px-10 md:text-lg`}
              >
                Get started
              </a>
            </div>
